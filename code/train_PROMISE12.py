...
if __name__ == "__main__":
    ...
    snapshot_path = "/data/chy_data/ABD-main/model/Cross_Teaching/PROMISE12_{}_{}".format(args.exp, args.labeled_num)
    if not os.path.exists(snapshot_path):
        os.makedirs(snapshot_path)
    shutil.copy('/data/chy_data/ABD-main/code/train_PROMISE12.py', snapshot_path)
